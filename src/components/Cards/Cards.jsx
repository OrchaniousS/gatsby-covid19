    ...
    <div className={styles.container}>
      ...
      <Grid container spacing={3} justify="center">
        <CardComponent
          ...
          iconClassName={
            <Icon className="fa fa-biohazard" style={{ color: purple[600] }} />
          }
        />
        <CardComponent
          ...
          iconClassName={
            <Icon className="fa fa-biohazard" style={{ color: "#fffff" }} />
          }
        />
        <CardComponent
        ...
        <CardComponent
          ...
          iconClassName={
            <Icon className="fa fa-procedures" style={{ color: red[500] }} />
          }
        />
      </Grid>
    </div>
